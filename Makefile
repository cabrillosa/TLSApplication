...
server:socket_proxy.h socket_proxy.c server.c openssl_proxy.h openssl_proxy.c
	$(CC) $(CFLAGS) $^ -o $@ $(INCLUDEPATH) $(LIBS) $(LIBPATH)

client:socket_proxy.h socket_proxy.c client.c openssl_proxy.h openssl_proxy.c
	$(CC) $(CFLAGS) $^ -o $@ $(INCLUDEPATH) $(LIBS) $(LIBPATH)
